...
def is_duplicated_number(three_digit):
    ...
    for i in three_digit:
        tmp.add(i)
    result = False if len(tmp) == 3 else True
    # ==================================
    return result
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = True if one_more_input.upper() == "Y" or one_more_input.upper() == "YES" else False
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = True if one_more_input.upper() == "N" or one_more_input.upper() == "NO" else False
    # ==================================
    return result
...
def main():
    ...
    while True:
        user_input = input("Input guess number : ").rstrip()
        ...
        if strike == 3:
            ...
            while not is_yes(one_more_input) and not is_no(one_more_input):
                one_more_input = input("You win, one more(Y/N) ?").rstrip()
                if not is_yes(one_more_input) and not is_no(one_more_input):
                    print("Wrong Input, Input again")
